...
Public Class UCDividendsPayments
    Private Shared _instance As UCDividendsPayments
    Private IsEdit As Boolean
    Private ID As Integer
    Public Shared ReadOnly Property Instance As UCDividendsPayments
        Get
            If _instance Is Nothing Then _instance = New UCDividendsPayments()
            Return _instance
        End Get
    End Property
#Region "SUBS"
    ...
    Sub SavePlough()
        ...
        Try
            ...
            Using connection = New SqlConnection(connstr)
                ...
                sql = "INSERT INTO tblBonus (ID,memberNo,amount,yearName,staus,transferRef,PloughedAs) VALUES(@id,@member,@amount,@year,@status,@tref,@plough)"
